...
GSE172120_raw<- ReadAffy(filenames = cel.files) #读取文件
sampleNames(GSE172120_raw) #列出样本名
#the length of name maybe 8,9 or 10 #将样本名定义为前8，9,或10位
sampleNames(GSE172120_raw)<-stri_sub(sampleNames(GSE172120_raw),1,10)#the length of name maybe 8,9 or 10 #将样本名定义为前8位
