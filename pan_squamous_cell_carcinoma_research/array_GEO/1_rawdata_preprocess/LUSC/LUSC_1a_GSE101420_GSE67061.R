###GSE102420和GSE67061是出自同一个课题组之手，可合并分析
...
##选择工作路径
setwd("D:\\鳞癌分析\\泛鳞癌array数据\\LUSC\\GSE101420_RAW")
dir = getwd()
...
####GSE67061整理
setwd("D:\\鳞癌分析\\泛鳞癌array数据\\LUSC\\GSE67061_RAW")
dir = getwd()
...
pheno_GSE67061 = phe_GSE67061[-c(1:8),]##只选择其中的鳞癌样本
