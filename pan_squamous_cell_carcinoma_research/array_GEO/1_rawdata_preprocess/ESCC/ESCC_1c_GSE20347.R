...
##dir <- choose.dir(caption = "D:\\ESCCmRNA-from rawdata\\GSE20347_RAW")
dir = "D:\\ESCC_Subtype_research\\GSE20347_RAW"
setwd("D:\\ESCC_Subtype_research\\GSE20347_RAW")
getwd()
# list the ".CEL" files
...
library(affy)
GSE20347_raw<- ReadAffy(filenames = cel.files)#读入文件
sampleNames(GSE20347_raw)

##rename samples
library(stringi)
sampleNames(GSE20347_raw)<-stri_sub(sampleNames(GSE20347_raw),1,9)##8或9或10
sampleNames(GSE20347_raw)
