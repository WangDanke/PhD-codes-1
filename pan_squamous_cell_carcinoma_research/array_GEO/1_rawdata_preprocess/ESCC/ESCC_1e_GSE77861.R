...
##dir <- choose.dir(caption = "D:\\ESCCmRNA-from rawdata\\GSE77861_RAW")
dir = "D:\\ESCC_Subtype_research\\GSE77861_RAW"
setwd("D:\\ESCC_Subtype_research\\GSE77861_RAW")
getwd()
# list the ".CEL" files
...
library(affy)
GSE77861_raw<- ReadAffy(filenames = cel.files)#读入文件
sampleNames(GSE77861_raw)

##rename samples
library(stringi)
sampleNames(GSE77861_raw)<-stri_sub(sampleNames(GSE77861_raw),1,10)##8或9或10
sampleNames(GSE77861_raw)
