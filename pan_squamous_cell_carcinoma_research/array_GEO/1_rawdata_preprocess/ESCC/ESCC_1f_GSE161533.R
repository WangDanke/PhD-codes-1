#ESCCï¼ŒGSE161533ï¼Œclinical message and raw data process.
###loading packages
...
##function "choose.dirï¼ˆï¼‰" to choose folder
##dir <- choose.dir(caption = "D:\\ESCCmRNA-from rawdata\\GSE161533_RAW")
dir = "D:\\ESCC_Subtype_research\\GSE161533_RAW"
setwd("D:\\ESCC_Subtype_research\\GSE161533_RAW")
getwd()
# list the ".CEL" files
...
library(affy)
GSE161533_raw<- ReadAffy(filenames = cel.files)#è¯»å…¥æ–‡ä»¶
sampleNames(GSE161533_raw)

##rename samples
library(stringi)
sampleNames(GSE161533_raw)<-stri_sub(sampleNames(GSE161533_raw),1,10)##8æˆ–9æˆ–10
sampleNames(GSE161533_raw)
