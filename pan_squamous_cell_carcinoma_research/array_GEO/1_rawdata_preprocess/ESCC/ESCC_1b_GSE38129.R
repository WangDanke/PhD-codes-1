...
##dir <- choose.dir(caption = "D:\\ESCCmRNA-from rawdata\\GSE38129_RAW")
dir = "D:\\ESCC_Subtype_research\\GSE38129_RAW"
setwd("D:\\ESCC_Subtype_research\\GSE38129_RAW")
getwd()
# list the ".CEL" files
...
##rename samples
library(stringi)
sampleNames(GSE38129_raw)<-stri_sub(sampleNames(GSE38129_raw),1,9)##8或9或10
sampleNames(GSE38129_raw)
