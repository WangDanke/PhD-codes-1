...
##dir <- choose.dir(caption = "D:\\ESCCmRNA-from rawdata\\GSE100942_RAW")
dir = "D:\\ESCC_Subtype_research\\GSE100942_RAW"
...
library(affy)
GSE100942_raw<- ReadAffy(filenames = cel.files)#读入文件
sampleNames(GSE100942_raw)

##rename samples
library(stringi)
sampleNames(GSE100942_raw)<-stri_sub(sampleNames(GSE100942_raw),1,10)##8或9或10
sampleNames(GSE100942_raw)
