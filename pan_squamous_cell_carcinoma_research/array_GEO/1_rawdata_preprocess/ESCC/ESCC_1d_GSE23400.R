...
##dir <- choose.dir(caption = "D:\\ESCCmRNA-from rawdata\\GSE23400_96_RAW")
dir = "D:\\ESCC_Subtype_research\\GSE23400_RAW"
setwd("D:\\ESCC_Subtype_research\\GSE23400_RAW")
getwd()
# list the ".CEL" files
...
library(affy)
GSE23400_96_raw<- ReadAffy(filenames = cel.files)#读入文件
sampleNames(GSE23400_96_raw)

##rename samples
library(stringi)
sampleNames(GSE23400_96_raw)<-stri_sub(sampleNames(GSE23400_96_raw),1,9)##8或9或10
sampleNames(GSE23400_96_raw)
...
###整理临床信息
setwd("D:\\ESCC_Subtype_research\\GSE23400_96_RAW")
getwd()
library(tidyr)
library(dplyr)
library(stringr)
