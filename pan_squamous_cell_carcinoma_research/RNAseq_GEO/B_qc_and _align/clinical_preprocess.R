...
####
####cervical SCC
setwd("D:\\桌面\\GEO\\clinical\\Cervical SCC")
getwd()
...
pheno_GSE223804 = phe_GSE223804[,c(1,46,10,11)]###有几列名字一样，所以直接使用编号
...
#合并
pheno_OSCC = rbind(pheno_GSE176221[,c("Sample_title","ID","sample_type","organ","ID_SRR")],
